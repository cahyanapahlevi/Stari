...
<body>
	<header>		
      ...
      <ul class="right hide-on-med-and-down">
        ...
        <li class="geserkanan"><a class="dropdown-button glow" href="#!" data-activates="dropdown1" data-beloworigin="true">ABOUT US<i class="material-icons right">arrow_drop_down</i></a></li>
     ...
     <ul class="side-nav" id="mobile-demo">
       ...
       <li class=""><a class="dropdown-button glow" href="#!" data-activates="dropdown2" data-beloworigin="true">ABOUT US<i class="material-icons right">arrow_drop_down</i></a></li>
       <ul id="dropdown2" class="dropdown-content about-dropdown">
         ...
         <li><a href="views/nm-OS.php">OUR<br>CONTACT</a></li>
       </ul>
			...
			<div class="container">
				<div class="row">
					<div class="col s12 kotakputih">
						<div class="col s12 kotak-join"><h5 class="center-align" style="opacity: 1; color: black"><br>SEJARAH SINGKAT</h5></div>
