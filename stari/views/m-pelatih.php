...
<body>
	<header>
      ...
      <ul class="right hide-on-med-and-down">
					...
					<li class="geserkanan active"><a class="glow" href="m-pelatih.php">PAKET</a></li>
			...
			<div class="container">
				<div class="row">
					<div class="col s12 kotakputih">
						<div class="col s12 kotak-join"><h5 class="center-align" style="opacity: 1; color: gray"><br>DAFTAR PAKET</h5></div>
