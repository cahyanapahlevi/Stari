        ...
        <nav>
            <div class="nav-wrapper">
                <a class="brand-logo" href="#!">
					...
					<li class="geserkanan active"><a class="glow" href="admin-anggota.php">ANGGOTA</a></li>
                    ...
                    <div class="row">
                        <div class="col s12 kotakputih">
                            <div class="col s12 kotak-join">
                                <h5 class="center-align" style="opacity: 1; color: gray"><br>DAFTAR ANGGOTA</h5>
            ...
            <table class="bordered responsive-table centered">
                <thead>
                    <tr>
						...
						<th data-field="tempat">JENIS KELAMIN</th>
                    </tr>
                </thead>
                <?php 
                ...
                foreach ($db->
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <a class="btn-floating btn-small waves-effect waves-light btn" href="admin-editformschedule.php?id=<?php echo $row['id_schedule'] ?>" id="action" name="action" style="width: 65px; height: 50px">
